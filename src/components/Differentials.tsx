      ...
      <div className="container-custom relative z-10">
        ...
        <div className="mb-16 text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/10 px-4 py-2">
            <span className="text-sm font-medium text-accent">Por que escolher a Foco Protect?</span>
          </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {differentials.map((item, index) => (
            <div
              key={index}
              className="group flex gap-4 rounded-xl border border-border bg-card p-6 transition-all duration-300 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/10"
            >
