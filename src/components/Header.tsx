      ...
      <div className="container-custom">
        <div className="flex h-24 items-center justify-between">
          ...
          <div className="hidden items-center gap-4 lg:flex">
            <a target="_blank" rel="noopener noreferrer" className="btn-accent text-sm" href="https://wa.me/5531920013756">
        ...
        {isMenuOpen && <nav className="border-t border-border bg-background pb-6 pt-4 lg:hidden">
            <div className="flex flex-col gap-4">
              ...
              <a href="https://wa.me/5531920013756" target="_blank" rel="noopener noreferrer" className="btn-accent mt-2 text-center text-sm">
                <Phone className="h-4 w-4" />
                Falar com Especialista
              </a>
            </div>
