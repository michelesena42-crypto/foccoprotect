      ...
      <div className="container-custom">
        <div className="flex h-24 items-center justify-between">
          ...
          <a href="#inicio" className="flex items-center gap-2">
            <span className="font-display text-xl font-bold text-foreground">Focco Protect</span>
          </a>
          ...
          <div className="hidden items-center gap-4 lg:flex">
            <a target="_blank" rel="noopener noreferrer" className="btn-accent text-sm" href="https://wa.me/5531933015705">
        ...
        {isMenuOpen && <nav className="border-t border-border bg-background pb-6 pt-4 lg:hidden">
            <div className="flex flex-col gap-4">
              ...
              <a href="https://wa.me/5531933015705" target="_blank" rel="noopener noreferrer" className="btn-accent mt-2 text-center text-sm">
                <Phone className="h-4 w-4" />
                Falar com Especialista
              </a>
            </div>
