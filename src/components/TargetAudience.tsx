      ...
      <div className="container-custom relative z-10">
        ...
        <div className="mb-12 text-center">
          <h2 className="mb-4 font-display text-3xl font-bold sm:text-4xl">
            Para Quem é a{" "}
            <span className="gradient-text">Foco Protect</span>
          </h2>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {audiences.map((item, index) => (
            <div
              key={index}
              className="group rounded-xl border border-border bg-background p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10"
            >
