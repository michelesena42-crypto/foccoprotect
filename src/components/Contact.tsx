...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappNumber = "5531933015705";
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            {/* WhatsApp Button */}
            <a target="_blank" rel="noopener noreferrer" className="group flex items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-green-600 to-green-500 px-8 py-4 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/30" href="https://wa.me/5531933015705">
